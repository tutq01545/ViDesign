...
namespace Acme.ViDesign.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ViDesignDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ViDesignEfCoreEntityExtensionMappings to extend the IdentityUser entity
